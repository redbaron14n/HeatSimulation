...
HTCS_600_10_CONSTANT_ARRAY = np.array([[0., 600., 10.]], dtype=np.float64)

HTCS_300_10_CONSTANT_ARRAY = np.array([[0., 300., 10.]], dtype=np.float64)

HTCS_600_10_10_5_300_ARRAY = np.array([ # 0.1s chop time, 0.05s transfer time, 3s period
    [0., 10., 10.],
    [0.1, 10., 10.],
    [0.15, 600., 10.],
    [2.95, 600., 10.]
...
HTCS_300_10_10_5_300_ARRAY = np.array([
    [0., 10., 10.],
    [0.1, 10., 10.],
    [0.15, 300., 10.],
    [2.95, 300., 10.]
...
HTCS_100_5_50_2_300_ARRAY = np.array([
    [0., 5., 5.],
    [0.5, 5., 5.],
    [0.52, 100., 5.],
    [2.98, 100., 5.]
...
K10_TRIAL = (9.21e-5, 10, np.array([[400., 0.15], [1000., 0.25]], dtype=np.float64))